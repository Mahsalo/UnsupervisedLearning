...
##Finding the indices of one-hot vector labels
def one_hot2num(labels):###The input is a multi-dimensional Numpy array
    ...
    print('This shows the length of the one-hot vector',len(labels[0]))##This shows the length of the one-hot vector
